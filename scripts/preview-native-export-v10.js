...
async function generatePreview() {
    console.log(':: NATIVE EXPORT PREVIEW (V10 - Seamless Gradient) :: Initializing...');
    ...
    try {
        ...
        console.log('Applying Micro-Universe V10 (Linear Gradient)...');
        ...
        await page.evaluate(() => {
            ...
            // The user reported a "seam" in the radial gradient. 
            // We switch to Linear Gradient for the base to guarantee vertical smoothness.
            // We also soften the yellow flare.
            ...
            // REMOVED GRAIN from V9 to ensure cleanness
        ...
        console.log('Capturing Snapshot V10...');
        await wrapperHandle.screenshot({
            path: path.join(CONFIG.outputDir, 'preview-micro-universe-010.png'),
            omitBackground: true
        });

        console.log(`\nPREVIEW GENERATED: ${path.join(CONFIG.outputDir, 'preview-micro-universe-010.png')}`);

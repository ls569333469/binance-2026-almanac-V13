...
async function generatePreview() {
    console.log(':: NATIVE EXPORT PREVIEW (V7 - Pure Glass) :: Initializing...');
    ...
    try {
        ...
        console.log('Applying Micro-Universe V7 (Pure Glass)...');
        ...
        console.log('Capturing Snapshot V7...');
        await wrapperHandle.screenshot({
            path: path.join(CONFIG.outputDir, 'preview-micro-universe-007.png'),
            omitBackground: true
        });

        console.log(`\nPREVIEW GENERATED: ${path.join(CONFIG.outputDir, 'preview-micro-universe-007.png')}`);

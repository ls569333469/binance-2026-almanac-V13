...
async function generatePreview() {
    console.log(':: NATIVE EXPORT PREVIEW (V8 - Cinematic Grading) :: Initializing...');
    ...
    try {
        ...
        console.log('Applying Micro-Universe V8 (Cinematic)...');
        ...
        await page.evaluate(() => {
            ...
            // V8 TUNING: Slightly lift the bottom black from #000 to #030305 to prevent crushed blacks on OLEDs
            // This is "Cinematic Black" vs "Mathematical Black"
            const exactGradient = 'radial-gradient(circle at 50% 0%, #151921 0%, #030305 85%), radial-gradient(circle at 85% 30%, rgba(240, 185, 11, 0.08) 0%, transparent 50%)';
            const exactBgColor = '#030305';
        ...
        console.log('Capturing Snapshot V8...');
        await wrapperHandle.screenshot({
            path: path.join(CONFIG.outputDir, 'preview-micro-universe-008.png'),
            omitBackground: true
        });

        console.log(`\nPREVIEW GENERATED: ${path.join(CONFIG.outputDir, 'preview-micro-universe-008.png')}`);

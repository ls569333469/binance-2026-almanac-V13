...
const CONFIG = {
    ...
    // Use a date known to have SHORT text to test flex-grow behavior
...
async function generatePreview() {
    console.log(':: NATIVE EXPORT PREVIEW (V11 - Dual Anchor & Logo Fix) :: Initializing...');
    ...
    try {
        ...
        console.log('Applying Micro-Universe V11 (Dual Anchor)...');
        ...
        console.log('Capturing Snapshot V11...');
        await wrapperHandle.screenshot({
            path: path.join(CONFIG.outputDir, 'preview-micro-universe-011.png'),
            omitBackground: true
        });

        console.log(`\nPREVIEW GENERATED: ${path.join(CONFIG.outputDir, 'preview-micro-universe-011.png')}`);
